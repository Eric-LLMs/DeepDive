...
#deckCover((title_lines: ("RAG Survey",), subtitle_lines: ("Engineers · Technical Masterclass",), sources_label: "Sources", sources: ("doc1.pdf",)))
#pagebreak()
#thesisSlide((title_lines: ("Title 1",), title_pt: 26, kicker_lines: (), kicker_pt: 16, message_lines: ("Message number 1.",), message_pt: 34, chips: (), citations: ()))
#pagebreak()
#cardsSlide((title_lines: ("Title 2",), title_pt: 26, kicker_lines: ("Message number 2.",), kicker_pt: 16, body: (cols: 4, rows: 1, gap_mm: 8.0, slot_w_mm: 70.67, slot_h_mm: 140.5, cards: ((label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12), (label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12), (label_lines: ("L3",), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12), (label_lines: ("L4",), label_pt: 16, detail_lines: ("takeaway 4",), detail_pt: 12))), citations: ("[doc1:3]",)))
#pagebreak()
#flowSlide((title_lines: ("Title 3",), title_pt: 26, kicker_lines: ("Message number 3.",), kicker_pt: 16, body: (n: 3, gap_mm: 10.0, node_w_mm: 95.56, node_h_mm: 30.0, steps: ((label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12, when_lines: (), when_pt: 12), (label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12, when_lines: (), when_pt: 12), (label_lines: ("L3",), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12, when_lines: (), when_pt: 12)), loop_label: "feedback loop"), citations: ("[doc1:3]",)))
#pagebreak()
#timelineSlide((title_lines: ("Title 4",), title_pt: 26, kicker_lines: ("Message number 4.",), kicker_pt: 16, body: (n: 3, gap_mm: 6.0, node_w_mm: 98.22, node_h_mm: 0.0, steps: ((label_lines: (), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12, when_lines: ("L1",), when_pt: 12), (label_lines: (), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12, when_lines: ("L2",), when_pt: 12), (label_lines: (), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12, when_lines: ("L3",), when_pt: 12)), loop_label: "feedback loop"), citations: ("[doc1:3]",)))
#pagebreak()
#loopSlide((title_lines: ("Title 5",), title_pt: 26, kicker_lines: ("Message number 5.",), kicker_pt: 16, body: (n: 3, gap_mm: 10.0, node_w_mm: 95.56, node_h_mm: 30.0, steps: ((label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12, when_lines: (), when_pt: 12), (label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12, when_lines: (), when_pt: 12), (label_lines: ("L3",), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12, when_lines: (), when_pt: 12)), loop_label: "feedback loop"), citations: ("[doc1:3]",)))
#pagebreak()
#funnelSlide((title_lines: ("Title 6",), title_pt: 26, kicker_lines: ("Message number 6.",), kicker_pt: 16, body: (levels: ((w_mm: 251.47, label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12, fill: "#5E718C", text: "#FFFFFF"), (w_mm: 184.0, label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12, fill: "#96A2B4", text: "#22303C"), (w_mm: 116.53, label_lines: ("L3",), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12, fill: "#CED4DC", text: "#22303C")), level_h_mm: 42.83, gap_mm: 6.0), citations: ("[doc1:3]",)))
#pagebreak()
#compareSlide((title_lines: ("Title 7",), title_pt: 26, kicker_lines: ("Message number 7.",), kicker_pt: 16, body: (cols: ((header_lines: ("L1",), header_pt: 16, cells: ((lines: ("takeaway 1",), pt: 12),)), (header_lines: ("L2",), header_pt: 16, cells: ((lines: ("takeaway 2",), pt: 12),)), (header_lines: ("L3",), header_pt: 16, cells: ((lines: ("takeaway 3",), pt: 12),))), gap_mm: 6.0, col_w_mm: 98.22), citations: ("[doc1:3]",)))
#pagebreak()
#archSlide((title_lines: ("Title 8",), title_pt: 26, kicker_lines: ("Message number 8.",), kicker_pt: 16, body: (bands: ((group_lines: ("L1",), group_pt: 12, nodes: ((lines: ("takeaway 1",), pt: 16, detail: ""),), node_w_mm: 145.34), (group_lines: ("L2",), group_pt: 12, nodes: ((lines: ("takeaway 2",), pt: 16, detail: ""),), node_w_mm: 145.34), (group_lines: ("L3",), group_pt: 12, nodes: ((lines: ("takeaway 3",), pt: 16, detail: ""),), node_w_mm: 145.34)), band_h_mm: 41.5, gap_mm: 8.0, direction: "layers-top-down"), citations: ("[doc1:3]",)))
#pagebreak()
#cardsSlide((title_lines: ("Title 9",), title_pt: 26, kicker_lines: ("Message number 9.",), kicker_pt: 16, body: (cols: 2, rows: 2, gap_mm: 8.0, slot_w_mm: 149.34, slot_h_mm: 66.25, cards: ((label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12), (label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12), (label_lines: ("L3",), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12), (label_lines: ("L4",), label_pt: 16, detail_lines: ("takeaway 4",), detail_pt: 12))), citations: ("[doc1:3]",)))
#pagebreak()
#tableSlide((title_lines: ("Title 10",), title_pt: 26, kicker_lines: ("Message number 10.",), kicker_pt: 16, body: (rows: ((label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12), (label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12), (label_lines: ("L3",), label_pt: 16, detail_lines: ("takeaway 3",), detail_pt: 12)), left_fr: 0.32), citations: ("[doc1:3]",)))
#pagebreak()
#chartSlide((title_lines: ("Title 11",), title_pt: 26, kicker_lines: ("Message number 11.",), kicker_pt: 16, body: (kind: "bar", plot_w_mm: 286.67, plot_h_mm: 116.5, v_min: 0.0, v_max: 0.9, series: ((name: "Title 11", points: ((x_mm: 47.78, y_mm: 64.72, value: 0.4, label_lines: ("Q1",)), (x_mm: 143.34, y_mm: 43.36, value: 0.565, label_lines: ("Q2",)), (x_mm: 238.89, y_mm: 0.0, value: 0.9, label_lines: ("Q3",)))),), grid: 4), citations: ()))
#pagebreak()
#figureSlide((title_lines: ("Title 12",), title_pt: 26, kicker_lines: ("Message number 12.",), kicker_pt: 16, body: (name: "figure_s12.png", w_mm: 129.5, h_mm: 129.5, caption_lines: ("Figure 1: the RAG pipeline",), caption_pt: 12, notes: (cols: 1, rows: 2, gap_mm: 8.0, slot_w_mm: 104.27, slot_h_mm: 66.25, cards: ((label_lines: ("L1",), label_pt: 16, detail_lines: ("takeaway 1",), detail_pt: 12), (label_lines: ("L2",), label_pt: 16, detail_lines: ("takeaway 2",), detail_pt: 12))), img_col_fr: 1.824, gap_mm: 12.27), citations: ("[doc1:3]",)))
