...
class ChatFunnelEventModel(Base):
    ...
    # Phase 6 (dark launch, settings.chat_funnel_trace_capture): the rebuilt
    # candidate-card summary + query + verdict. NULL unless capture is ON —
    # never the full prompt (the verbatim prompt stays in the log tooling).
